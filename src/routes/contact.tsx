    ...
    >
      ...
      >
        <div className="md:flex">
          ...
          <motion.div 
            className="md:w-1/3 bg-gradient-to-br from-green-50 to-green-100 p-8 flex flex-col justify-center items-center"
          ...
          >
            ...
            <motion.div 
              className="bg-white p-4 rounded-lg shadow-sm w-full mt-auto"
